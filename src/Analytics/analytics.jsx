      ...
      <main className="min-w-0 flex-1 overflow-y-auto p-3 sm:p-5">
        ...
        {loading ? (
          ...
          <>
            ...
            <p className="text-sm text-gray-600 mb-4">Detailed statistics for each course including average attendance.</p>
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                ...
                {departmentComparison.length > 0 ? (
                  <div className="space-y-2">
                    {departmentComparison.slice(0, 10).map((dept, idx) => (
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 mb-6">
              {atRiskStudents.length > 0 ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  <p>No at-risk students found. Excellent attendance across the board!</p>
                </div>
              )}
            </div>
          </>
